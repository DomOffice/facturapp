...
import {
  genererDocumentPDF,
  TypeDocument,
} from "@/lib/exports/pdf/facture-pdf";
        ...
        >
          <div className="bg-white rounded-xl shadow-2xl p-6 w-96 border border-slate-200">
            ...
            <div className="mb-4">
              ...
              <select
                value={typeDoc}
                onChange={(e) => setTypeDoc(e.target.value as TypeDocument)}
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-2">
                <input
                  type="checkbox"
                  id="showEch"
                  checked={afficherEcheance}
                  onChange={(e) => setAfficherEcheance(e.target.checked)}
                  className="w-4 h-4"
                />
                <label
                  htmlFor="showEch"
                ...
                <div className="space-y-2 pl-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEcheanceValeur(e.target.value)}
                      className="form-input"
                      placeholder="ex: 30 jours, 15/04/2026..."
                    />
                  </div>
                  <div>
