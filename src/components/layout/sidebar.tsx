...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/sync", label: "Synchronisation", icon: <IconSync /> },
    ],
  },
];
...
export default function Sidebar() {
  ...
  const navContent = (
    <>
      ...
      >
        <div>
          <div className="font-display text-white text-base font-bold leading-none">
            FacturApp
          </div>
          <div
  ...
  return (
    <>
      {/* DESKTOP */}
      <aside
        className="hidden md:flex w-52 flex-shrink-0 flex-col h-screen sticky top-0"
      ...
      <div className="md:hidden">
        ...
        <aside
          className="fixed top-0 left-0 z-50 h-full w-64 flex flex-col transition-transform duration-300"
          style={{
            background: "var(--sidebar-bg)",
...
function IconBox() {
  return (
    ...
    >
      ...
      <path d="M8 1v14M1 4.5l7 3.5 7-3.5" />
    </svg>
  );
}
function IconDevis() {
...
function IconAvoir() {
  return (
    ...
    >
      <path d="M3 1h10a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z" />
      <path d="M5 5h6M5 8h4M10 11l-2 2-2-2" />
    </svg>
  );
}
function IconDoc() {
...
function IconUsers() {
  return (
    ...
    >
      ...
      <path d="M11 7c1.5 0 2.5 1 2.5 2.5" />
      <path d="M13 14c0-1.5-1-2.5-2.5-2.5" />
    </svg>
  );
}
